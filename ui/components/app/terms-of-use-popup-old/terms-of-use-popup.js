...
export default function TermsOfUsePopup({ onAccept }) {
  ...
  return (
    <Popover
      className="terms-of-use-old__popover"
      ...
      footer={
        <>
          <Button
            ...
            className="terms-of-use-old__button"
            onClick={onAccept}
            disabled={!isTermsOfUseChecked}
            data-testid="terms-of-use-old-accept-button"
          >
            {t('accept')}
          </Button>
          <Text
            as="p"
            marginTop={4}
            className="terms-of-use-old__footer-text"
    ...
    >
      <Box className="terms-of-use-old">
        <Box
          className="terms-of-use-old__content"
          marginBottom={4}
          marginLeft={4}
          marginRight={4}
        >
          ...
          <Box as="ol" marginLeft={4} className="terms-of-use-old__terms-list">
          ...
          >
            <Checkbox
              id="terms-of-use-old__checkbox"
              className="terms-of-use-old__checkbox"
              data-testid="terms-of-use-old-checkbox"
