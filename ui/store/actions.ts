...
/**
 * Creates a new vault and backups the seed phrase with social login.
 *
 * @param password - The password to use for the new vault.
 * @returns The seed phrase.
 */
export function createNewVaultAndBackupSeedPhrase(
  password: string,
): ThunkAction<void, MetaMaskReduxState, unknown, AnyAction> {
  return async (dispatch: MetaMaskReduxDispatch) => {
    dispatch(showLoadingIndication());
